...
class QRCodeLogin:
    ...
    def generate_qr_code(self) -> Tuple[str, str]:
        ...
        try:
            ...
            if data.get("code") == 0:
                ...
                logger.error("Failed to generate QR code", code=data.get("code"), message=data.get("message"))
    ...
    def poll_qr_login(self, qrcode_key: str) -> Optional[str]:
        ...
        try:
            ...
            if code == 86101:
                # Not scanned yet
                logger.info("QR code not scanned yet")
                return None
            elif code == 86090:
    ...
    def login_with_browser(self) -> str:
        ...
        try:
            ...
            print(f"Failed to open browser automatically. Please visit {login_url} manually.")
...
"""
    ...
    def save_cookie_to_file(self, cookie_str: str, filepath: str = "cookie.txt") -> None:
        """
        Save cookie to file
